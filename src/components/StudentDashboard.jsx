...
const StudentDashboard = (props) => {
  ...
  return (
    <div className=" min-h-screen w-full flex flex-col bgGlass rounded-xl shadow-md text-slate-700 py-3 px-2 mx-auto">
      <h1 className=" font-medium text-2xl md:text-3xl text-center border-b-4 border-b-orange-300 pb-3">
        Student Details
      </h1>

      <div className=" mx-auto text-lg md:text-xl mt-10 py-6 md:py-10 px-6 md:px-10 bg-opacity-30 bg-slate-100 md:w-5/6 rounded-2xl shadow-sm grid grid-cols-1 md:grid-cols-3 gap-7 md:gap-5">
